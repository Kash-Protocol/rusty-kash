let kash = require('./kash/kash_wasm');
let {
    PrivateKey,
    PublicKey,
    XPublicKey,
...
// Getting Kash Address from Private Key
...
function demoGenerateAddressFromPublicKeyHexString() {
    ...
    console.info(publicKey.toAddress(NetworkType.Mainnet).toString() == 'kash:qr0lr4ml9fn3chekrqmjdkergxl93l4wrk3dankcgvjq776s9wn9j35khpy0x');
    ...
    console.info(xOnlyPublicKey.toAddress(NetworkType.Mainnet).toString() == 'kash:qr0lr4ml9fn3chekrqmjdkergxl93l4wrk3dankcgvjq776s9wn9j35khpy0x');
    ...
    console.info(fullDERPublicKey.toAddress(NetworkType.Mainnet).toString() == 'kash:qqs7krzzwqfgk9kf830smtzg64s9rf3r0khfj76cjynf2pfgrr35s6ydald9m');
}