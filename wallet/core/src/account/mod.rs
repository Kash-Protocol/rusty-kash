...
use kash_bip32::{ChildNumber, ExtendedPrivateKey, PrivateKey, PrivateKeyBytes};
...
pub trait Account: AnySync + Send + Sync + 'static {
    ...
    async fn transfer(
        ...
        let final_transaction_destination =
            PaymentDestination::from(PaymentOutput::new(destination_address, transfer_amount_sompi, asset_type));
...
mod tests {
    ...
    use kash_bip32::secp256k1::SecretKey;
    use kash_bip32::PrivateKey;
    use kash_bip32::SecretKeyExt;
    use std::str::FromStr;
