//!
//! Legacy (KDX, kashnet.io Web Wallet) account implementation
//!
...
pub const LEGACY_ACCOUNT_KIND: &str = "kash-legacy-standard";
...
impl Factory for Ctor {
    ...
    fn description(&self) -> String {
        "Kash Legacy Account (KDX, kashnet.io Web Wallet)".to_string()
    }
