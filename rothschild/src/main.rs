...
use kash_grpc_client::{ClientPool, GrpcClient};
...
const DEFAULT_SEND_AMOUNT: u64 = 10 * SOMPI_PER_KASH;
...
async fn refresh_utxos(
    ...
    fetch_spendable_utxos(rpc_client, kash_addr, coinbase_maturity, pending).await
}
