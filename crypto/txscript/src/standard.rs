...
use kash_consensus_core::tx::{ScriptPublicKey, ScriptVec};
    ...
    fn test_extract_address_and_encode_script() {
        ...
        let tests = vec![
            Test {
                ...
                expected_address: Ok("kash:qpauqsvk7yf9unexwmxsnmg547mhyga37csh0kj53q6xxgl24ydxjh3y20yhf".try_into().unwrap()),
            },
            Test {
                ...
                expected_address: Ok("kashtest:qxaqrlzlf6wes72en3568khahq66wf27tuhfxn5nytkd8tcep2c0vrsc6st700t".try_into().unwrap()),
            },
            Test {
