...
mod tests {
    ...
    use kash_consensus_core::{
        constants::{SOMPI_PER_KASH, STORAGE_MASS_PARAMETER},
    ...
    fn test_mass_storage() {
        ...
        tx2.tx.outputs[0].value = 10 * SOMPI_PER_KASH;
