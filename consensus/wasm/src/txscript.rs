...
impl ScriptBuilder {
    ...
    /// and any push of data greater than [`MAX_SCRIPT_ELEMENT_SIZE`](kash_txscript::MAX_SCRIPT_ELEMENT_SIZE) will not modify
    ...
    /// exceed the maximum allowed script engine size [`MAX_SCRIPTS_SIZE`](kash_txscript::MAX_SCRIPTS_SIZE).
