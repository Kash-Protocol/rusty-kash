...
pub fn hash(tx: &Transaction, include_mass_field: bool) -> Hash {
    let mut hasher = kash_hashes::TransactionHash::new();
...
pub(crate) fn id(tx: &Transaction) -> TransactionId {
    ...
    let mut hasher = kash_hashes::TransactionID::new();
...
mod tests {
    ...
    fn test_transaction_hashing() {
        ...
        let outputs = vec![TransactionOutput::new(1564, ScriptPublicKey::new(7, scriptvec![1, 2, 3, 4, 5]), AssetType::KSH)];
