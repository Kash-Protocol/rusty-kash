...
For mining, grab the `kashminer` from within the latest [Go release](https://github.com/Kash-Protocol/kashd/releases) and run it with the following flags:
    ```
    kashminer --testnet --miningaddr <address> --target-blocks-per-second=0
    ```
