...
use kash_wallet_core::error::Error as WalletError;
...
pub enum Error {
    ...
    #[error(transparent)]
    WrpcError(#[from] kash_wrpc_client::error::Error),

    #[error(transparent)]
    RpcError(#[from] kash_rpc_core::RpcError),
