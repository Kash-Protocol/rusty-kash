...
//! since the syncee no longer uses them in the rusty-kash design where the full sub-DAG is sent
//!
...
use kash_p2p_lib::{
    ...
    pb::{
        self, kashd_message::Payload, BlockWithTrustedDataV4Message, DoneBlocksWithTrustedDataMessage, PruningPointsMessage,
        TrustedDataMessage,
    },
