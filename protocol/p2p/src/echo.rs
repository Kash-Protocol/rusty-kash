use crate::{
    ...
    handshake::KashdHandshake,
    pb::{self, VersionMessage},
    IncomingRoute, KashdMessagePayloadType, Router,
};
use kash_core::{debug, time::unix_now, trace, warn};
use std::sync::Arc;
...
impl EchoFlow {
    pub async fn register(router: Arc<Router>) {
        ...
        let receiver = router.subscribe(vec![
            KashdMessagePayloadType::Addresses,
            KashdMessagePayloadType::Block,
            KashdMessagePayloadType::Transaction,
            KashdMessagePayloadType::BlockLocator,
            KashdMessagePayloadType::RequestAddresses,
            KashdMessagePayloadType::RequestRelayBlocks,
            KashdMessagePayloadType::RequestTransactions,
            KashdMessagePayloadType::IbdBlock,
            KashdMessagePayloadType::InvRelayBlock,
            KashdMessagePayloadType::InvTransactions,
            KashdMessagePayloadType::Ping,
            KashdMessagePayloadType::Pong,
            // KashdMessagePayloadType::Verack,
            // KashdMessagePayloadType::Version,
            // KashdMessagePayloadType::Ready,
            KashdMessagePayloadType::TransactionNotFound,
            KashdMessagePayloadType::Reject,
            KashdMessagePayloadType::PruningPointUtxoSetChunk,
            KashdMessagePayloadType::RequestIbdBlocks,
            ...
            KashdMessagePayloadType::RequestNextHeaders,
            KashdMessagePayloadType::DoneHeaders,
            KashdMessagePayloadType::RequestPruningPointUtxoSet,
            KashdMessagePayloadType::RequestHeaders,
            KashdMessagePayloadType::RequestBlockLocator,
            KashdMessagePayloadType::PruningPoints,
            KashdMessagePayloadType::RequestPruningPointProof,
            ...
            KashdMessagePayloadType::RequestIbdChainBlockLocator,
            KashdMessagePayloadType::IbdChainBlockLocator,
            KashdMessagePayloadType::RequestAntipast,
    ...
    async fn call(&self, msg: pb::KashdMessage) -> bool {
        // echo
...
fn build_dummy_version_message() -> VersionMessage {
    pb::VersionMessage {
        ...
        subnetwork_id: None,
        network: "kash-mainnet".to_string(),
    }
}
...
impl ConnectionInitializer for EchoFlowInitializer {
    async fn initialize_connection(&self, router: Arc<Router>) -> Result<(), ProtocolError> {
        //
        // Example code to illustrate kash P2P handshaking
        //
...
mod tests {
    ...
    async fn test_handshake() {
        kash_core::log::try_init_logger("debug");
