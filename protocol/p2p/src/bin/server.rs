use kash_core::debug;
use kash_p2p_lib::echo::EchoFlowInitializer;
...
async fn main() {
    // [-] - init logger
    kash_core::log::init_logger(None, "debug");
    ...
    let adaptor = kash_p2p_lib::Adaptor::bidirectional(ip_port, kash_p2p_lib::Hub::new(), initializer, Default::default()).unwrap();
