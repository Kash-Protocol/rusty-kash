...
from!(item: &kash_rpc_core::RpcHeader, protowire::RpcBlockHeader, {
    Self {
...
try_from!(item: &protowire::RpcBlockHeader, kash_rpc_core::RpcHeader, {
...
mod tests {
    use crate::protowire;
    use kash_rpc_core::{RpcHash, RpcHeader};
