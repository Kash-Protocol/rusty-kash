...
from!(item: &kash_rpc_core::RpcTransaction, protowire::RpcTransaction, {
    Self {
...
from!(item: &kash_rpc_core::RpcTransactionInput, protowire::RpcTransactionInput, {
    Self {
...
from!(item: &kash_rpc_core::RpcTransactionOutput, protowire::RpcTransactionOutput, {
    Self {
        amount: item.value,
...
from!(item: &kash_rpc_core::RpcTransactionOutpoint, protowire::RpcOutpoint, {
    Self { transaction_id: item.transaction_id.to_string(), index: item.index }
});

from!(item: &kash_rpc_core::RpcUtxoEntry, protowire::RpcUtxoEntry, {
    Self {
        amount: item.amount,
        script_public_key: Some((&item.script_public_key).into()),
...
from!(item: &kash_rpc_core::RpcScriptPublicKey, protowire::RpcScriptPublicKey, {
    Self { version: item.version().into(), script_public_key: item.script().to_rpc_hex() }
});

from!(item: &kash_rpc_core::RpcTransactionVerboseData, protowire::RpcTransactionVerboseData, {
    Self {
...
from!(&kash_rpc_core::RpcTransactionInputVerboseData, protowire::RpcTransactionInputVerboseData);

from!(item: &kash_rpc_core::RpcTransactionOutputVerboseData, protowire::RpcTransactionOutputVerboseData, {
    Self {
...
from!(item: &kash_rpc_core::RpcAcceptedTransactionIds, protowire::RpcAcceptedTransactionIds, {
    Self {
...
from!(item: &kash_rpc_core::RpcUtxosByAddressesEntry, protowire::RpcUtxosByAddressesEntry, {
    Self {
...
try_from!(item: &protowire::RpcTransaction, kash_rpc_core::RpcTransaction, {
    Self {
        version: item.version.try_into()?,
        inputs: item
            .inputs
            .iter()
            .map(kash_rpc_core::RpcTransactionInput::try_from)
            .collect::<RpcResult<Vec<kash_rpc_core::RpcTransactionInput>>>()?,
        outputs: item
            .outputs
            .iter()
        ...
        verbose_data: item.verbose_data.as_ref().map(kash_rpc_core::RpcTransactionVerboseData::try_from).transpose()?,
    }
});

try_from!(item: &protowire::RpcTransactionInput, kash_rpc_core::RpcTransactionInput, {
    Self {
        ...
        verbose_data: item.verbose_data.as_ref().map(kash_rpc_core::RpcTransactionInputVerboseData::try_from).transpose()?,
    }
});

try_from!(item: &protowire::RpcTransactionOutput, kash_rpc_core::RpcTransactionOutput, {
    Self {
        value: item.amount,
...
try_from!(item: &protowire::RpcOutpoint, kash_rpc_core::RpcTransactionOutpoint, {
    Self { transaction_id: RpcHash::from_str(&item.transaction_id)?, index: item.index }
});

try_from!(item: &protowire::RpcUtxoEntry, kash_rpc_core::RpcUtxoEntry, {
    Self {
        amount: item.amount,
        script_public_key: item
            .script_public_key
...
try_from!(item: &protowire::RpcScriptPublicKey, kash_rpc_core::RpcScriptPublicKey, {
    Self::new(u16::try_from(item.version)?, RpcScriptVec::from_rpc_hex(item.script_public_key.as_str())?)
});

try_from!(item: &protowire::RpcTransactionVerboseData, kash_rpc_core::RpcTransactionVerboseData, {
    Self {
...
try_from!(&protowire::RpcTransactionInputVerboseData, kash_rpc_core::RpcTransactionInputVerboseData);

try_from!(item: &protowire::RpcTransactionOutputVerboseData, kash_rpc_core::RpcTransactionOutputVerboseData, {
    Self {
...
try_from!(item: &protowire::RpcAcceptedTransactionIds, kash_rpc_core::RpcAcceptedTransactionIds, {
    Self {
...
try_from!(item: &protowire::RpcUtxosByAddressesEntry, kash_rpc_core::RpcUtxosByAddressesEntry, {
