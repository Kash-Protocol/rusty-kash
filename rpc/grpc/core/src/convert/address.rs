...
from!(item: &kash_rpc_core::RpcBalancesByAddressesEntry, protowire::RpcBalancesByAddressesEntry, {
...
try_from!(item: &protowire::RpcBalancesByAddressesEntry, kash_rpc_core::RpcBalancesByAddressesEntry, {
