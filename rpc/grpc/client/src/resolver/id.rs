use crate::{
    error::{Error, Result},
    resolver::{KashdResponseReceiver, KashdResponseSender, Resolver},
};
use kash_core::trace;
use kash_grpc_core::{
    ops::KashdPayloadOps,
...
impl Pending {
    fn new(sender: KashdResponseSender) -> Self {
...
impl Resolver for IdResolver {
    fn register_request(&self, _: KashdPayloadOps, request: &KashdRequest) -> KashdResponseReceiver {
