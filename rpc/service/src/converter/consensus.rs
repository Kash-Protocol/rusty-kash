...
use kash_consensus_notify::notification::{self as consensus_notify, Notification as ConsensusNotification};
use kash_consensusmanager::{ConsensusManager, ConsensusProxy};
use kash_math::Uint256;
use kash_mining::model::{owner_txs::OwnerTransactions, TransactionIdSet};
use kash_notify::converter::Converter;
use kash_rpc_core::{
...
use kash_txscript::{extract_script_pub_key_address, script_class::ScriptClass};
...
impl ConsensusConverter {
    ...
    ///
    /// _GO-KASHD: PopulateBlockWithVerboseData_
    ...
    ///
    /// _GO-KASHD: PopulateTransactionWithVerboseData
