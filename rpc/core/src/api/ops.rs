...
use kash_notify::events::EventType;
...
pub enum RpcApiOps {
    ...
    GetSyncStatus,
    /// Returns the network this Kashd is connected to (Mainnet, Testnet)
    GetCurrentNetwork,
    ...
    GetBlockTemplate,
    /// Returns a list of all the addresses (IP, port) this Kashd knows and a list of all addresses that are currently banned by this Kashd
    GetPeerAddresses,
    ...
    GetMempoolEntries,
    /// Returns a list of the peers currently connected to this Kashd, along with some statistics on them
    GetConnectedPeerInfo,
    /// Instructs Kashd to connect to a given IP address.
    AddPeer,
